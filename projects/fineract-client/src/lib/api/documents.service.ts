...
export class DocumentsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getDocument(entityType: string, entityId: number, documentId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<GetEntityTypeEntityIdDocumentsResponse>;
    public getDocument(entityType: string, entityId: number, documentId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<GetEntityTypeEntityIdDocumentsResponse>>;
    public getDocument(entityType: string, entityId: number, documentId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<GetEntityTypeEntityIdDocumentsResponse>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public retrieveAllDocuments(entityType: string, entityId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<GetEntityTypeEntityIdDocumentsResponse>>;
    public retrieveAllDocuments(entityType: string, entityId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<GetEntityTypeEntityIdDocumentsResponse>>>;
    public retrieveAllDocuments(entityType: string, entityId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<GetEntityTypeEntityIdDocumentsResponse>>>;
