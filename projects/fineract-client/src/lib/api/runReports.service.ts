...
export class RunReportsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public runReport(reportName: string, isSelfServiceUserReport?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'application/pdf' | 'application/vnd.ms-excel' | 'text/csv' | 'text/html', context?: HttpContext, transferCache?: boolean}): Observable<RunReportsResponse>;
    public runReport(reportName: string, isSelfServiceUserReport?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'application/pdf' | 'application/vnd.ms-excel' | 'text/csv' | 'text/html', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<RunReportsResponse>>;
    public runReport(reportName: string, isSelfServiceUserReport?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'application/pdf' | 'application/vnd.ms-excel' | 'text/csv' | 'text/html', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<RunReportsResponse>>;
    public runReport(reportName: string, isSelfServiceUserReport?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'application/pdf' | 'application/vnd.ms-excel' | 'text/csv' | 'text/html', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (reportName === null || reportName === undefined) {
