...
export class StandingInstructionsService {
     ...
     */
    public create5(postStandingInstructionsRequest: PostStandingInstructionsRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<PostStandingInstructionsResponse>;
    public create5(postStandingInstructionsRequest: PostStandingInstructionsRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<PostStandingInstructionsResponse>>;
    public create5(postStandingInstructionsRequest: PostStandingInstructionsRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<PostStandingInstructionsResponse>>;
    public create5(postStandingInstructionsRequest: PostStandingInstructionsRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
